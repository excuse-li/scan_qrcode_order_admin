  ...
  <div class="main-body">
    <div class="container">
      <div>
        ...
        <el-select size="mini" v-model="shop" style="width: 200px" placeholder="请选择所属门店">
          <el-option
            v-for="item in shops"
            :key="item.value"
            :label="item.name"
      ...
      <div style="margin: 10px 0">
        <el-button size="mini" type="primary" @click="toAddPrinter" icon="el-icon-plus">添加打印机</el-button>
        <el-select
          size="mini"
          v-model="set"
          multiple
...
export default {
  ...
  methods: {
    ...
    stateRow(item) {},
    editRow(row) {
      this.$router.push({path: '/shop/editPrinter'})
    },
